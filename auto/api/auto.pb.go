...
const file_auto_api_auto_proto_rawDesc = "" +
	...
	"\x05Empty26\n" +
	"\x06Github\x12,\n" +
	"\aWebhook\x12\x13.api.WebhookRequest\x1a\n" +
	".api.Empty\"\x00B#Z!github.com/bh90210/super/auto/apib\x06proto3"
...
var file_auto_api_auto_proto_depIdxs = []int32{
	0, // 0: api.Github.Webhook:input_type -> api.WebhookRequest
	1, // 1: api.Github.Webhook:output_type -> api.Empty
