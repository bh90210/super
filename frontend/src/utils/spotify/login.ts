...
const client_id = import.meta.env.VITE_SPOTIFY_CLIENT_ID as string || 'mock-client-id';
const redirect_uri = import.meta.env.VITE_SPOTIFY_REDIRECT_URL as string || 'http://localhost:3000';
